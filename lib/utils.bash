...
# NOTE: You might want to remove this if yay is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if yay has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Asert yay executable exists.
    local tool_cmd
